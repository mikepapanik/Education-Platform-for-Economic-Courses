...
namespace EducationEconomic
{
    public class sendmails
    {
        ...
        public void Sendmail(TextBox textBox1, TextBox textBox2)
        {
            ...
            try
            {
                msg = new MailMessage(textBox1.Text, "educatiooonplatform@gmail.com", "EducationPlatform ", textBox2.Text);
            }
            ...
            mail.Port = 587;
            mail.Credentials = new NetworkCredential("educatiooonplatform@gmail.com", "mp963258");
            mail.EnableSsl = true;
